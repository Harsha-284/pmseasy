$(document).ready(function(){
	...
	if ($('#weather-widget-1').length > 0){
		$("#weather-widget-1").backstretch("images/img-12.jpg");
	}
	if ($('#weather-widget-2').length > 0){
		$("#weather-widget-2").backstretch("images/img-13.jpg");
	}
	if ($('#search-heading').length > 0){
		$("#search-heading").backstretch("images/img-12.jpg");
	}
	if ($('#property-search-wrap').length > 0){
		$("#property-search-wrap").backstretch("images/img-19.jpg");
	}
	/** END BACK STRETCH **/
